...
function getDotsRotateTl() {
  ...
  dotsRotateTl
    .to(
      $dotRed,
      0.9,
      { bezier: { curviness: 1.5, values: pathRed, ease: Power2.easeInOut } },
      "move"
    )
    .to(
      $dotYellow,
      1.2,
      { bezier: { curviness: 1, values: pathYellow, ease: Power2.easeInOut } },
      "move"
    )
    .to(
      $dotGreen,
      1.5,
      { bezier: { curviness: 1, values: pathGreen, ease: Power2.easeInOut } },
      "move"
    );
...
function getDrawGTl() {
  ...
  drawGTl
    ...
    .fromTo(
      ...
      0.5,
      { drawSVG: "71% 88%" },
      { drawSVG: "0% 26%", ease: Power1.easeOut },
      "-=0.2"
    )
    ...
    .fromTo(
      ...
      0.6,
      { drawSVG: "71% 88%" },
      { drawSVG: "17% 36%", ease: Power2.easeOut },
      "-=0.45"
    )
    .set(
      $dotYellow,
    ...
    .fromTo(
      ...
      0.55,
      { drawSVG: "71% 88%" },
      { drawSVG: "36% 61%", ease: Power2.easeOut },
      "-=0.6"
    )
    .set(
      $dotGreen,
    ...
    .fromTo(
      ...
      0.55,
      { drawSVG: "71% 88%" },
      { drawSVG: "61% 78%", ease: Power2.easeOut },
      "-=0.55"
    )
    ...
    .fromTo(
      $gRedb,
      0.7,
      { rotation: "-10", drawSVG: "100% 100%" },
      { rotation: "0", drawSVG: "80% 100%", ease: Power2.easeOut },
      "-=0.22"
    );
...
function getBackToDotsTl() {
  ...
  backToDotsTl
    ...
    .to(
      $gBlue,
      0.3,
      { drawSVG: "56% 78%", ease: Power0.easeNone },
      "rotateG-=0.3"
    )
    .to(
      $gGreen,
      0.3,
      { drawSVG: "31% 56%", ease: Power0.easeNone },
      "rotateG-=0.3"
    )
    .to(
      $gYellow,
      0.3,
      { drawSVG: "12% 31%", ease: Power0.easeNone },
      "rotateG-=0.3"
    )
    .to(
      $gRed,
      0.3,
      { drawSVG: "0% 21%", ease: Power0.easeNone },
      "rotateG-=0.3"
    )
    ...
    .to(
      $gGreen,
      0.4,
      { drawSVG: "10% 20%", ease: Power0.easeNone },
      "rotateCircles"
    )
    .to(
      $gYellow,
    ...
    .to(
      $gBlue,
      0.4,
      { drawSVG: "50% 60%", ease: Power0.easeNone },
      "rotateCircles"
    )
    .to(
      $gRed,
      0.1,
      { drawSVG: "0% 0%", ease: Power0.easeNone },
      "rotateCircles"
    )
    .to(
      $gRedb,
      0.3,
      { rotation: "+=50", drawSVG: "80% 90%", ease: Power2.easeInOut },
      "rotateCircles"
    )
    ...
    .to(
      $dotRed,
      0.9,
      { bezier: { curviness: 1.5, values: pathRedBack, ease: Power2.easeOut } },
      "rotateCircles+=0.1"
    )
    ...
    .to(
      ...
      0.6,
      {
        bezier: { curviness: 1.5, values: pathBlueBack, ease: Power2.easeOut }
      },
      "rotateCircles+=0.3"
    )
    ...
    .to(
      ...
      0.7,
      {
        bezier: { curviness: 1.5, values: pathYellowBack, ease: Power2.easeOut }
      },
      "rotateCircles+=0.4"
    )
    ...
    .to(
      ...
      0.6,
      {
        bezier: { curviness: 1.5, values: pathGreenBack, ease: Power2.easeOut }
      },
      "rotateCircles+=0.4"
    )
    ...
    .to(
      $gMask,
      0.3,
      { rotation: "+=60", transformOrigin: "-9 58", ease: Power2.easeInOut },
      "rotateCircles"
    );
